...
namespace GPUInstancerPro.PrefabModule
{
    ...
    public class GPUIMaterialVariationInstance : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            _gpuiPrefab.OnInstancingStatusModified -= ApplyVariation;
            _gpuiPrefab.OnInstancingStatusModified += ApplyVariation;
            _gpuiPrefab.OnBufferIndexModified -= ApplyVariationWithBufferIndex;
            _gpuiPrefab.OnBufferIndexModified += ApplyVariationWithBufferIndex;
        }
        ...
        private void ApplyVariationWithBufferIndex(int bufferIndex)
        {
            ApplyVariation();
        }
