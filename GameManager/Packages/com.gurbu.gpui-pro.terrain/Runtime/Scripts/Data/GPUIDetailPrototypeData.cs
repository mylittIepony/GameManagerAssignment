...
namespace GPUInstancerPro.TerrainModule
{
    ...
    public class GPUIDetailPrototypeData : GPUIPrototypeData
    {
        ...
        public Color healthyColor = new Color(0.2627f, 0.9765f, 0.1647f);
        public Color dryColor = new Color(0.8039f, 0.7373f, 0.1020f);
        ...
        private void CreateSubSettingAtIndex(int subSettingIndex)
        {
            ...
            else if (_prototypeSubSettings.Length <= subSettingIndex)
            {
                ...
                //Debug.Log(GPUIConstants.LOG_PREFIX + "Adding sub setting at index: " + subSettingIndex);
        ...
        public int GetFirstNoiseSeed()
        {
            if (_prototypeSubSettings != null && _prototypeSubSettings.Length > 0 && _prototypeSubSettings[0] != null)
                return _prototypeSubSettings[0].noiseSeed;
            return 0;
        }
