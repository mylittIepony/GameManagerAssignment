...
namespace GPUInstancerPro
{
    public static class GPUIEditorTextUtility
    {
        ...
        public static GPUIText EMPTY_GPUI_TEXT = new GPUIText("", "");

        public static bool TryGetGPUIText(string textCode, out GPUIText gpuiText)
        {
            gpuiText = EMPTY_GPUI_TEXT;
            if (!string.IsNullOrEmpty(textCode) && textCode != "data")
            {
                ...
                {
#if GPUIPRO_DEVMODE
                    Debug.LogWarning(GPUIConstants.LOG_PREFIX + GPUIConstants.LOG_PREFIX_DEV + "Can not find editor text for textCode: " + textCode + ". Adding automatically.");
#endif
                    ...
                    if (!string.IsNullOrEmpty(line))
                    {
                        ...
                        if (split.Length >= 4)
                        {
                            ...
                            if (!textDictionary.ContainsKey(code))
                            {
                                ...
                                Debug.LogError(GPUIConstants.LOG_PREFIX + GPUIConstants.LOG_PREFIX_DEV + "Duplicate codeText: " + split[0]);
#endif
                        }
#if GPUIPRO_DEVMODE
                        else
                            Debug.LogError(GPUIConstants.LOG_PREFIX + GPUIConstants.LOG_PREFIX_DEV + "Incorrect split at line " + lineCount);
#endif
                    }
                }
            }
        ...
        public class GPUIText
        {
            ...
            public bool IsValid()
            {
                ...
                {
                    Debug.LogError(GPUIConstants.LOG_PREFIX + GPUIConstants.LOG_PREFIX_DEV + "Invalid codeText!");
                    return false;
                }
                //if (string.IsNullOrEmpty(title))
                //{
                //    Debug.LogError(GPUIConstants.LOG_PREFIX + "Invalid title for: " + codeText);
                //    return false;
                //}
                //if (string.IsNullOrEmpty(tooltip))
                //{
                //    Debug.LogError(GPUIConstants.LOG_PREFIX + "Invalid tooltip for: " + codeText);
                //    return false;
                //}
                // Allow not having helpText
                //if (string.IsNullOrEmpty(helpText))
                //{
                //    Debug.LogError(GPUIConstants.LOG_PREFIX + "Invalid helpText for: " + codeText);
                //    return false;
                //}
#endif
                return true;
