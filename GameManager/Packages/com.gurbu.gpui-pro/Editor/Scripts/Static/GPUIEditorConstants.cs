...
namespace GPUInstancerPro
{
    public static class GPUIEditorConstants
    {
        ...
        public static float LABEL_WIDTH = GPUIConstants.LABEL_WIDTH;

        public static readonly string SD_NO_UNSUPPORTED_LOGS = "GPUIPRO_NO_UNSUPPORTED_LOGS";
        ...
        public static readonly string ERRORTEXT_shaderConversionWithCrowd = "Can not automatically add procedural GPU instancing setup to shader: {0}. Crowd Animations extension requires shader modifications for GPU skinning. See documentation:\nhttps://wiki.gurbu.com/index.php?title=GPU_Instancer_Pro-Crowd_Animations#Shader_Setup_Guide\n\n";
        ...
        {
            int dialogOption = EditorUtility.DisplayDialogComplex("GPUI Shader Setup", "Create a new patched shader or overwrite the original?", "Create Shader", "Cancel", "Overwrite");
            if (dialogOption == 1)
                return;
            ...
            if (shaders != null)
            {
                ...
                {
                    GPUIShaderUtility.SetupShaderForGPUI(shaders[i], null, true, true, true, dialogOption == 2);
                }
            }
        ...
        [MenuItem("Tools/GPU Instancer Pro/Reimport Packages", validate = true, priority = 501)]
        public static bool ReimportPackagesValidate()
        {
        ...
        [MenuItem("Tools/GPU Instancer Pro/Import Demos", validate = true, priority = 502)]
        public static bool ImportDemoPackagesValidate()
        {
            return !Application.isPlaying;
        }
        ...
        public static GameObject ToolbarAddDebuggerCanvas()
        {
            ...
            Undo.RegisterCreatedObjectUndo(result, "Add Debugger Canvas");
