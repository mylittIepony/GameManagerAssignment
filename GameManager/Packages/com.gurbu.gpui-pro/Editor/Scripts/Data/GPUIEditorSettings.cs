...
namespace GPUInstancerPro
{
    ...
    public class GPUIEditorSettingsEditor : GPUIEditor
    {
        public override void DrawContentGUI(VisualElement contentElement)
        {
            ...
            Toggle noUnsupportedLogToggle = new Toggle("No Unsupported Platform Logs");
            noUnsupportedLogToggle.tooltip = "When enabled, GPUI will not show error logs for unsupported platforms.";
            bool isUnsupportedLogsDisabled = GPUIDefines.HasDefineSymbol(GPUIEditorConstants.SD_NO_UNSUPPORTED_LOGS);
            noUnsupportedLogToggle.value = isUnsupportedLogsDisabled;
            noUnsupportedLogToggle.RegisterValueChangedCallback(evt =>
            {
                if (isUnsupportedLogsDisabled != evt.newValue)
                {
                    GPUIDefines.SetDefineSymbol(GPUIEditorConstants.SD_NO_UNSUPPORTED_LOGS, evt.newValue);
                    isUnsupportedLogsDisabled = evt.newValue;
                }
            });
            contentElement.Add(noUnsupportedLogToggle);
