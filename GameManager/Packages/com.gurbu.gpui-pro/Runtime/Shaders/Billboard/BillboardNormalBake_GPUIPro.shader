Shader "Hidden/GPUInstancerPro/Billboard/NormalBake"
{	
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : SV_Target
            {
				...
				float3 textureNormal = tex2D(_BumpMap, i.uv);
				...
				// remap normals to [0, 1] (a is depth atlas) and account for gamma correction if necessary
