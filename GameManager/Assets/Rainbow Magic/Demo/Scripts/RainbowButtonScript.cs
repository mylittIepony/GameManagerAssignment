...
namespace RainbowMagic
{
    public class RainbowButtonScript : MonoBehaviour
    {
        ...
        RainbowFireProjectile effectScript;        // A variable used to access the list of projectiles
        RainbowProjectileScript projectileScript;
        ...
        void Start()
        {
            effectScript = GameObject.Find("RainbowFireProjectile").GetComponent<RainbowFireProjectile>(); // The FireProjectile script needs to be on a gameobject called FireProjectile, or else it won't be found
            getProjectileNames();
        ...
        public void getProjectileNames()            // Find and diplay the name of the currently selected projectile
        {
            ...
            projectileScript = effectScript.projectiles[effectScript.currentProjectile].GetComponent<RainbowProjectileScript>();// Access the currently selected projectile's 'ProjectileScript'
