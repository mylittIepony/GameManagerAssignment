...
namespace SymmetryBreakStudio.TastyGrassShader
{
    ...
    public class TgsPreset : ScriptableObject
    {
        ...
        static readonly int StemLeaveCount = Shader.PropertyToID("_StemLeaveCount");
        ...
        [DisableGroup(nameof(stemGenerate))] [Tooltip("How many leaves to generate per stem.")] [Range(1, 16)]
        public int stemLeavesCount = 4;
        ...
        [DisableGroup(nameof(proceduralShapeBlend), ValueType.FloatAsInt, 0)]
        [Range(0.0f, 4.0f)]
...
#pragma warning restore CS0612 // Type or member is obsolete
            ...
            int csBakePassId)
        {
            ...
            tgsComputeShader.SetInt(ClumpCount, stemGenerate ? stemLeavesCount : clumpCount);
            ...
            tgsComputeShader.SetInt(StemLeaveCount, stemGenerate ? stemLeavesCount : 0);
        ...
        public void ApplyLayerSettingsToBuffer(ComputeBuffer buffer, Settings settings, int index)
        {
            ...
            buffer.SetData(_noiseLayerBuffers, 0, index * NoiseSettingGPU.MaxCount, 4);
        }
        ...
        {
            {
                ...
                bakeSettingsHash.Append(stemLeavesCount);
        ...
        public struct NoiseSetting
        {
            ...
            [DisableGroup(nameof(disable), ValueType.Int, 1)]
            public float tiling;
