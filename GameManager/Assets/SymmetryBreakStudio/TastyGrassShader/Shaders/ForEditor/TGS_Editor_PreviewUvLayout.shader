Shader "Hidden/Symmetry Break Studio/Tasty Grass Shader/Editor/Preview UV Layout"
{
    ...
    SubShader
    {
        ...
        editor_preview_uv_layout_v2f tgs_editor_preview_uv_vert(editor_preview_uv_layout_appdata v,
uint vertexId : SV_VertexID)
        ...
        float4 tgs_editor_preview_uv_frag(editor_preview_uv_layout_v2f i) : SV_Target
        {
            ...
            float smoothness;
            float occlusion;
            TgsGetSurfaceParameters(barycentricCoord, 0xFFFFFFFF, /*out*/ albedo, /*out*/ alpha, /*out*/ smoothness,
    /*out*/ occlusion);
            float4 vista = 0;
            vista.rgb = albedo;
            ...
            const float leftTriangleSdf = sdTriangle(i.uv, float2(1.0, 0.0) + pixelSize2x,
                                      float2(0.0, 1.0) + pixelSize2x, float2(0.0, 0.0) + pixelSize2x);
